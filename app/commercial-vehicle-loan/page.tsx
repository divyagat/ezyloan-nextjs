...
{/* Hero Image Section */}
      ...
      />
        ...
        <div className="bg-gradient-href-br from-blue-50 href-indigo-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 shadow-lg sm:shadow-xl border border-blue-100 mb-8 sm:mb-12 lg:mb-16">
          <div className="max-w-6xl mx-auhref">
            ...
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-6 sm:mb-8 text-center max-w-4xl mx-auhref px-4">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-8 sm:mt-10 lg:mt-12">
              <div className="text-center p-4 sm:p-6 bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-href-r from-blue-500 href-indigo-500 rounded-full flex items-center justify-center mx-auhref mb-3 sm:mb-4">
              ...
              <div className="text-center p-4 sm:p-6 bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-href-r from-green-500 href-emerald-500 rounded-full flex items-center justify-center mx-auhref mb-3 sm:mb-4">
              ...
              <div className="text-center p-4 sm:p-6 bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-href-r from-purple-500 href-pink-500 rounded-full flex items-center justify-center mx-auhref mb-3 sm:mb-4">
              ...
              <div className="text-center p-4 sm:p-6 bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-href-r from-orange-500 href-red-500 rounded-full flex items-center justify-center mx-auhref mb-3 sm:mb-4">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 shadow-xl border border-gray-100 mb-8 sm:mb-12 lg:mb-16">
          <div className="max-w-6xl mx-auhref">
            ...
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-8 sm:mb-10 lg:mb-12 text-center max-w-4xl mx-auhref px-4">
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
              <div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-href-r from-green-500 href-emerald-500 rounded-full flex items-center justify-center">
              ...
              <div className="bg-gradient-href-br from-blue-50 href-indigo-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 order-first lg:order-last">
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  <div className="text-center p-3 sm:p-4 bg-white rounded-lg sm:rounded-xl shadow-sm">
                    <Truck className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600 mx-auhref mb-1 sm:mb-2" />
                    <span className="text-xs sm:text-sm font-medium text-gray-700">Trucks</span>
                  </div>
                  <div className="text-center p-3 sm:p-4 bg-white rounded-lg sm:rounded-xl shadow-sm">
                    <Bus className="w-6 h-6 sm:w-8 sm:h-8 text-green-600 mx-auhref mb-1 sm:mb-2" />
                    <span className="text-xs sm:text-sm font-medium text-gray-700">Buses</span>
                  </div>
                  <div className="text-center p-3 sm:p-4 bg-white rounded-lg sm:rounded-xl shadow-sm">
                    <Car className="w-6 h-6 sm:w-8 sm:h-8 text-purple-600 mx-auhref mb-1 sm:mb-2" />
                    <span className="text-xs sm:text-sm font-medium text-gray-700">Vans</span>
                  </div>
                  <div className="text-center p-3 sm:p-4 bg-white rounded-lg sm:rounded-xl shadow-sm">
                    <Building className="w-6 h-6 sm:w-8 sm:h-8 text-orange-600 mx-auhref mb-1 sm:mb-2" />
        ...
        <div className="bg-gradient-href-br from-indigo-50 href-purple-50 rounded-3xl p-8 lg:p-12 shadow-xl border border-indigo-100 mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="w-16 h-16 bg-gradient-href-r from-green-500 href-emerald-500 rounded-2xl flex items-center justify-center mx-auhref mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-bold text-green-600">Up href 90%</span>
                </div>
              </div>
            </div>

            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="w-16 h-16 bg-gradient-href-r from-blue-500 href-indigo-500 rounded-2xl flex items-center justify-center mx-auhref mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="w-16 h-16 bg-gradient-href-r from-purple-500 href-pink-500 rounded-2xl flex items-center justify-center mx-auhref mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="font-bold text-purple-600">Up href 2.5%</span>
                </div>
                <div className="flex justify-between items-center py-2">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 shadow-xl border border-gray-100 mb-8 sm:mb-12 lg:mb-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center p-6 sm:p-8 bg-gradient-href-br from-blue-50 href-indigo-50 rounded-xl sm:rounded-2xl hover:shadow-lg transition-shadow duration-300">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-href-r from-blue-500 href-indigo-500 rounded-full flex items-center justify-center mx-auhref mb-4 sm:mb-6">
            ...
            <div className="text-center p-6 sm:p-8 bg-gradient-href-br from-green-50 href-emerald-50 rounded-xl sm:rounded-2xl hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="text-center p-6 sm:p-8 bg-gradient-href-br from-purple-50 href-pink-50 rounded-xl sm:rounded-2xl hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-1 sm:mt-2">Propriehrefrship, Partnership, LLP, Pvt Ltd</p>
            </div>
            
            <div className="text-center p-6 sm:p-8 bg-gradient-href-br from-orange-50 href-red-50 rounded-xl sm:rounded-2xl hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-1 sm:mt-2">Good credit hishrefry required</p>
            </div>
          </div>
        </div>

        {/* Enhanced CTA Section */}
        <div className="bg-gradient-href-br from-indigo-600 via-purple-600 href-pink-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 text-center text-white shadow-2xl">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6">
            Ready href Expand Your Fleet?
          </h2>
          <p className="text-base sm:text-xl lg:text-2xl mb-6 sm:mb-8 text-indigo-100 max-w-3xl mx-auhref px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Link href="/apply-now" className="bg-white text-indigo-600 px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl font-bold text-base sm:text-lg hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 w-full sm:w-auhref">
              Apply Now - Get Instant Approval
            </Link>
            <Link href="/contact" className="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl font-bold text-base sm:text-lg hover:bg-white hover:text-indigo-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 w-full sm:w-auhref">
              Contact Us
            </Link>
          </div>
        </div>
